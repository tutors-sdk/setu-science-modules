...
<p><a href="./archives/A11943.pdf" target="_blank" rel="noopener noreferrer" style="display: inline-flex; align-items: center; text-decoration: none;"><img src="https://upload.wikimedia.org/wikipedia/commons/6/60/Adobe_Acrobat_Reader_icon_%282020%29.svg" width="20" height="20" style="margin-right: 4px;" alt="Adobe Acrobat Icon"><span>Module Descriptor (PDF)</span></a></p>
...
|-----------|-------------|
| **Module Code** | A11943 |
| **Module Title** | Advanced Engineering Maths |
...
Tutorials will focus on solving problems by hand calculation and using Mathlab.
...
| **Continuous Assessment** | 1,2,3,4 | **30%** |
| - Assignment | 1,2,3,4 | 15% |
| - Practical | 1,2,3,4 | 15% |
...
*Module Code: A11943 | Timetable Code: MTHE-0032*