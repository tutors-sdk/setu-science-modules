...
The module is designed to give a student the ability to understand, build and perform basic calculations on practical analog and digital electronic circuits commonly used in electrical engineering.

<p><a href="./archives/A05921.pdf" target="_blank" rel="noopener noreferrer" style="display: inline-flex; align-items: center; text-decoration: none;"><img src="https://upload.wikimedia.org/wikipedia/commons/6/60/Adobe_Acrobat_Reader_icon_%282020%29.svg" width="20" height="20" style="margin-right: 4px;" alt="Adobe Acrobat Icon"><span>Module Descriptor (PDF)</span></a></p>
...
|-----------|-------------|
| **Module Code** | A05921 |
| **Module Title** | Instrumentation & Measurement |
...
|---------------------|----------------------|---------------|
| **Final Written Examination** | 1,2,4,5,6 | **60%** |
...
|-------------------|---------------------|-----------|--------------|------------|
| WD_EAUTO_B | Bachelor of Engineering (Honours) in Automation Engineering with Data Intelligence | 2 | 3 | Mandatory |
| WD_EELCT_C | Higher Certificate in Engineering in Electrical Engineering | 2 | 3 | Mandatory |
| WD_EELCT_D | Bachelor of Engineering in Electrical Engineering | 2 | 3 | Mandatory |
| WD_ETRIC_B | Bachelor of Engineering (Honours) in Electrical Engineering | 2 | 3 | Mandatory |
| WD_ETRIC_B | Bachelor of Engineering (Honours) | 2 | 3 | Mandatory |
...
*Module Code: A05921 | Timetable Code: ENGR-0087*