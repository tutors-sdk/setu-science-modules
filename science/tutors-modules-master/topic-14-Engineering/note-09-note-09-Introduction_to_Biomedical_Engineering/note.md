...
This module aims to advance the students' knowledge of the fundamentals of biomedical engineering; specifically in respect of the analysis and evaluation of complex biomedical devices.

<p><a href="./archives/A66666.pdf" target="_blank" rel="noopener noreferrer" style="display: inline-flex; align-items: center; text-decoration: none;"><img src="https://upload.wikimedia.org/wikipedia/commons/6/60/Adobe_Acrobat_Reader_icon_%282020%29.svg" width="20" height="20" style="margin-right: 4px;" alt="Adobe Acrobat Icon"><span>Module Descriptor (PDF)</span></a></p>
...
|-----------|-------------|
| **Module Code** | A66666 |
| **Module Title** | Introduction to Biomedical Engineering |
...
| - Case studies/Practical/Project work | 1,2,3 | 50% |
...
Enderle, J., S. Blanchard and J. Bronzino. Introduction to Biomedical Engineering. .: Academic Press, 2005.
...
|-------------------|---------------------|-----------|--------------|------------|
| WD_EMSEN_B | Bachelor of Engineering (Honours) in Mechanical & Manufacturing Engineering | 4 | 8 | Elective |
...
*Module Code: A66666 | Timetable Code: ENGR-0157*