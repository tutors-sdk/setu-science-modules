...
The aim of this module is to provide the student with a professional level of understanding and the ability to apply relative design and calculation methods to the areas of electrical power generation, transmission, and distribution equipment.

<p><a href="./archives/A13089.pdf" target="_blank" rel="noopener noreferrer" style="display: inline-flex; align-items: center; text-decoration: none;"><img src="https://upload.wikimedia.org/wikipedia/commons/6/60/Adobe_Acrobat_Reader_icon_%282020%29.svg" width="20" height="20" style="margin-right: 4px;" alt="Adobe Acrobat Icon"><span>Module Descriptor (PDF)</span></a></p>
...
|---------------------|----------------------|---------------|
| **Final Written Examination** | 1,2,3,5,6,7 | **70%** |
| **Continuous Assessment** |  | **30%** |
| - Lab Report | 3,4,5,6 | 20% |
| - Project | 5,7 | 10% |
...
*Module Code: A13089 | Timetable Code: ELEC-0041*