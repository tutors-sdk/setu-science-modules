...
# Embed Systems Design Patterns (NUIST)

This module will cover the design and programming of embedded systems.

<p><a href="./archives/A35615.pdf" target="_blank" rel="noopener noreferrer" style="display: inline-flex; align-items: center; text-decoration: none;"><img src="https://upload.wikimedia.org/wikipedia/commons/6/60/Adobe_Acrobat_Reader_icon_%282020%29.svg" width="20" height="20" style="margin-right: 4px;" alt="Adobe Acrobat Icon"><span>Module Descriptor (PDF)</span></a></p>
...
|-----------|-------------|
| **Module Code** | A35615 |
| **Module Title** | Embedded Systems Design Patterns - NUIST |
...
| - Case Studies | 1,4,5,6 | 50% |
| - Case Studies | 1,2,3,5,6 | 50% |
...
*Module Code: A35615 | Timetable Code: EMBS-0001*