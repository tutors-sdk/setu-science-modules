...
This module concentrates on the Design, Management and Security aspects of Computer Networks.

<p><a href="./archives/A35618.pdf" target="_blank" rel="noopener noreferrer" style="display: inline-flex; align-items: center; text-decoration: none;"><img src="https://upload.wikimedia.org/wikipedia/commons/6/60/Adobe_Acrobat_Reader_icon_%282020%29.svg" width="20" height="20" style="margin-right: 4px;" alt="Adobe Acrobat Icon"><span>Module Descriptor (PDF)</span></a></p>
...
|-----------|-------------|
| **Module Code** | A35618 |
| **Module Title** | Communication Networks - NUIST |
...
3. Design he logic and physical LAN set up in a residential or co-operative environment.
...
- Routing Routing Protocols and Algorithms, Routing Tables
...
| WD_EELEN_RI | MEng in Electronic Information Systems | 2 | 3 | Mandatory |
...
*Module Code: A35618 | Timetable Code: N/A*