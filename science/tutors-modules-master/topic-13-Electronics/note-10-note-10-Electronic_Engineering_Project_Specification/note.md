...
The aim of the final year project subject is to augment the theoretical material, covered in the course, by exposing the student to circuit design and software development in a work laboratory environment.

<p><a href="./archives/A04231.pdf" target="_blank" rel="noopener noreferrer" style="display: inline-flex; align-items: center; text-decoration: none;"><img src="https://upload.wikimedia.org/wikipedia/commons/6/60/Adobe_Acrobat_Reader_icon_%282020%29.svg" width="20" height="20" style="margin-right: 4px;" alt="Adobe Acrobat Icon"><span>Module Descriptor (PDF)</span></a></p>
...
|-----------|-------------|
| **Module Code** | A04231 |
| **Module Title** | Electronic Engineering Project Specification |
...
*Module Code: A04231 | Timetable Code: PROJ-0094*