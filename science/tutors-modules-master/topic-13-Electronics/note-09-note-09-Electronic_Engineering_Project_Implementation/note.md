...
This module follows on from Project Specification described in the previous semester outline.

<p><a href="./archives/A05133.pdf" target="_blank" rel="noopener noreferrer" style="display: inline-flex; align-items: center; text-decoration: none;"><img src="https://upload.wikimedia.org/wikipedia/commons/6/60/Adobe_Acrobat_Reader_icon_%282020%29.svg" width="20" height="20" style="margin-right: 4px;" alt="Adobe Acrobat Icon"><span>Module Descriptor (PDF)</span></a></p>
...
|-----------|-------------|
| **Module Code** | A05133 |
| **Module Title** | Electronic Engineering Project Implementation |
...
4. Present a project context, status quo and achieved outcome to peers and staff in an open forum/seminar.
5. Accurately and faithfully represent their work in a project report, acknowledging where it occurs the presence and level of input of others.
6. Maintain a professional relationship with the supervisor and maintain a log of meetings.
...
Proof-reading and feedback of the early versions of the report
...
*Module Code: A05133 | Timetable Code: PROJ-0095*