...
This module is concerned with the implementation phase of the project.

<p><a href="./archives/A05848.pdf" target="_blank" rel="noopener noreferrer" style="display: inline-flex; align-items: center; text-decoration: none;"><img src="https://upload.wikimedia.org/wikipedia/commons/6/60/Adobe_Acrobat_Reader_icon_%282020%29.svg" width="20" height="20" style="margin-right: 4px;" alt="Adobe Acrobat Icon"><span>Module Descriptor (PDF)</span></a></p>
...
|-----------|-------------|
| **Module Code** | A05848 |
| **Module Title** | Engineering Technology Project Implementation |
...
| WD_EELEC_B | Bachelor of Science (Honours) in Applied Electronics | 2 | 4 | Mandatory |
| WD_EMSEN_B | Bachelor of Engineering (Honours) in Mechanical and Manufacturing Engineering | 4 | 8 | Mandatory |
...
| WD_TCAMF_B | Bachelor of Science (Honours) in Manufacturing Engineering | 1 | 2 | Mandatory |
...
*Module Code: A05848 | Timetable Code: N/A*