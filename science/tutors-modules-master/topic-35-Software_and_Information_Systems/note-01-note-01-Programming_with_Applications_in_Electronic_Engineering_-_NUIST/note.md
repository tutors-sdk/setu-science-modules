...
# Programming with Applications (NUIST)

The aim of this module is to highlight the computational approach to solving electrical engineering problems.

<p><a href="./archives/A35619.pdf" target="_blank" rel="noopener noreferrer" style="display: inline-flex; align-items: center; text-decoration: none;"><img src="https://upload.wikimedia.org/wikipedia/commons/6/60/Adobe_Acrobat_Reader_icon_%282020%29.svg" width="20" height="20" style="margin-right: 4px;" alt="Adobe Acrobat Icon"><span>Module Descriptor (PDF)</span></a></p>
...
|-----------|-------------|
| **Module Code** | A35619 |
| **Module Title** | Programming with Applications in Electronic Engineering - NUIST |
...
1. Utilise the procedural programming paradigm for problems in electronic engineering, such as code implementation of digital signals, periodigrams etc.
2. Design algorithms and programs using pseuduocode and flowcharts.
...
- Programming applications: Periodigrams, windowing function, code implementation of digital signals, convolution -- FIR filters, signal sequences, time varying FT (STFT), and wavelets.
...
- Siauw, T. and A. Bayen. _An Introduction to MATLAB® Programming and Numerical Methods for Engineers_. London: Academic Press, 2014.
...
|-------------------|---------------------|-----------|--------------|------------|
| WD_EELEN_G | Postgraduate Diploma in Engineering in Electronic Engineering | 1 | 1 | Elective |
| WD_EELEN_R | Master of Engineering in Electronic Engineering | 1 | 1 | Elective |
| WD_EELEN_RI | MEng in Electronic Information Systems | 1 | 2 | Elective |
...
*Module Code: A35619 | Timetable Code: MSTU-0001*