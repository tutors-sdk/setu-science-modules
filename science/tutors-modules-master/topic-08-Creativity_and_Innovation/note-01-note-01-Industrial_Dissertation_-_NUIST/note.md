...
The Industrial Project is a very significant component of the programme, providing students with the opportunity to apply engineering and related principles and theory in an innovative manner, or to develop innovative solutions to challenging engineering and scientific problems.

<p><a href="./archives/A35627.pdf" target="_blank" rel="noopener noreferrer" style="display: inline-flex; align-items: center; text-decoration: none;"><img src="https://upload.wikimedia.org/wikipedia/commons/6/60/Adobe_Acrobat_Reader_icon_%282020%29.svg" width="20" height="20" style="margin-right: 4px;" alt="Adobe Acrobat Icon"><span>Module Descriptor (PDF)</span></a></p>
...
|-----------|-------------|
| **Module Code** | A35627 |
| **Module Title** | Industrial Dissertation - NUIST |
...
|---------------------|----------------------|---------------|
| **Final Project** | 1,3,4,5,6,7,8,9 | **65%** |
| **Continuous Assessment** |  | **35%** |
| - Assignment | 1,2,6,7,9 | 10% |
| - Presentation | 1,2,6,7,9 | 5% |
| - Supervisor's Report | 1,2,6,7,9 | 3% |
| - Supervisor's Report | 1,3,4,5,6,7,8,9 | 7% |
| - Presentation | 1,2,3,4,5,6,7,8,9 | 5% |
| - Presentation | 1,2,3,4,5,6,7,8,9 | 5% |
...
|-------------------|---------------------|-----------|--------------|------------|
| WD_CINNT_R | Master of Science in Innovative Technology Engineering | 1 | 3 | Mandatory |
| WD_EELEN_R | Master of Engineering in Electronic Engineering | 1 | 3 | Mandatory |
| WD_EELEN_RI | MEng in Electronic Information Systems | 2 | 3 | Elective |
| WD_EELEN_RI | MEng in Electronic Information Systems | 2 | 4 | Elective |
| WD_EELEN_RI | MEng in Electronic Information Systems | 3 | 5 | Elective |
| WD_EELEN_RI | MEng in Electronic Information Systems | 3 | 6 | Elective |
...
*Module Code: A35627 | Timetable Code: DISS-0069*